...
* **Built and launched** the *world's first edible insect product with legal hemp-derived cannabinoids* (**Dusty Beetles**), including product, packaging, and brand—*sold the first product the same day the MVP was finished*.
* **Architected and delivered** *Automately Cloud*, an **open-source distributed backend platform**, and *led its acquisition and integration into a legal tech company*.
* **Scaled and operated multiple startups and e-commerce brands**, including *The Baked Potato Store* (**selling potatoes, bongs, and bags of bugs**) and *QuickStart.me* (**web-based phone and business platform**).
* **Rapidly prototyped and shipped MVPs** for startups, *landing first customers and iterating at startup speed*.
* **Played a key role** in developing the *Universal Shopping Cart platform*, which contributed to **Rakuten's $1B acquisition of Ebates**.
* **Led teams, managed infrastructure, and wore every hat** from founder to full-stack engineer, *thriving in fast-paced, ambiguous environments*.
